            ...
            <div class="col-lg-8">
                    ...
                    <div>
                        <div class="d-flex flex-column text-left mb-3">
                            ...
                            <img class="img-fluid rounded w-100 mb-4" src="{{asset('storage/'.$post->image) }}" style="max-height: 574px;object-fit:cover;"
                                alt="Image">
                            <h3 class="mb-3">{{$post->title}}</h3>

                            <div class="d-flex">
                                <p class="mr-3"><i class="fa fa-user text-primary"></i> Author: {{ $post->user_name }} |
                                </p>
                                <p class="mr-3">{{ date('M d, Y ', strtotime($post->created_at)) }} |</p>
                                <p class="mr-3"><i class="fa fa-eye text-3 mr-1"></i> 32 |</p>
                                <p class="mr-3"><i class="bi bi-chat-dots"></i> {{$post->getCommentCount()}} </p>
                      ...
                      <!-- Comment List -->
                      <div class="mb-5">
                        <h2 class="mb-4">{{$post->getComment->count()}} Comments</h2>
